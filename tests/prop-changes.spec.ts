...
test.describe.serial("Prop Changes", () => {
  ...
  // ---------------------------------------------------------------------------
  test("button default variant has no variant attribute override", async () => {
    await page.goto("/");
  ...
  test("button destructive variant renders", async () => {
    await page.goto("/");
  ...
  test("button all 10 variants render", async () => {
    await page.goto("/");
  ...
  // ---------------------------------------------------------------------------
  test("button all sizes render", async () => {
    await page.goto("/");
    const f = page.getByTestId("button-fixture");
  ...
  // ---------------------------------------------------------------------------
  test("button disabled prop prevents click", async () => {
    await page.goto("/");
  ...
  // ---------------------------------------------------------------------------
  test("button loading prop reflects in attribute", async () => {
    await page.goto("/");
  ...
  test("input default variant and placeholder", async () => {
    await page.goto("/");
  ...
  test("input all variants render", async () => {
    await page.goto("/");
  ...
  test("input type=email renders", async () => {
    await page.goto("/");
  ...
  test("textarea rows attribute", async () => {
    await page.goto("/");
  ...
  test("select placeholder renders", async () => {
    await page.goto("/");
  ...
  test("slider keyboard interaction updates value", async () => {
    await page.goto("/");
  ...
  test("slider Home/End keys", async () => {
    await page.goto("/");
  ...
  test("slider disabled prevents interaction", async () => {
    await page.goto("/");
  ...
  test("checkbox starts unchecked", async () => {
    await page.goto("/");
  ...
  test("switch starts checked", async () => {
    await page.goto("/");
  ...
  test("progress renders with correct value", async () => {
    await page.goto("/");
  ...
  test("list renders correct number of items", async () => {
    await page.goto("/");
  ...
  test("tooltip appears on hover with correct text", async () => {
    await page.goto("/");
  ...
  test("alert renders all variants", async () => {
    await page.goto("/");
  ...
  test("page has zero console errors", async () => {
    const errors: string[] = [];
